...
NS_RSS_09 = "{https://my.netscape.com/rdf/simple/0.9/}"
NS_RSS_10 = "{https://purl.org/rss/1.0/}"
...
class ElementWrapper:  # based on https://effbot.org/zone/element-rss-wrapper.htm
